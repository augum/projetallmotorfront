...
@Component({
  selector: 'app-articlestock',
  templateUrl: './articlestock.component.html',
  styleUrls: ['./articlestock.component.css']
})
 ...
 formtemplate = new FormGroup({
  ...
  chercher(formvalue){
    ...
    this.articleService.getAllpts(formvalue.nom,formvalue.mag)
      .subscribe(
        response =>{this.articles = response;console.log(this.articles)}
      );
  }
  get formControls(){
