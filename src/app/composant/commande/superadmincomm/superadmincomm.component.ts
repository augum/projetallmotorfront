...
@Component({
  selector: 'app-superadmincomm',
  templateUrl: './superadmincomm.component.html',
  styleUrls: ['./superadmincomm.component.css']
})
export class SuperadmincommComponent implements OnInit {
  commandeListe;
  listecom;
  p: number = 1;
  public somme=0;
