...
@Component({
  selector: 'app-addb-lcommande',
  templateUrl: './addb-lcommande.component.html',
  styleUrls: ['./addb-lcommande.component.scss']
})
export class AddbLcommandeComponent implements OnInit {
  formData: FormGroup;
  articleList:Article[];
  ...
  constructor( public service:BlcommandeService,private toastr :ToastrService,
        @Inject(MAT_DIALOG_DATA)  public data,
        public dialogRef:MatDialogRef<AddbLcommandeComponent>,
        private articleService:ArticleService,
        private commandeService:BcommandeService,public fb: FormBuilder){}
